...
function SkillCard({ title, description, steps }: SkillCardProps) {
  return (
    <div className="bg-gradient-to-r from-orange-50 to-amber-50 p-4 rounded-lg border border-yellow-200">
    ...
    <Card className="border-2 border-yellow-300">
      ...
      <CardContent className="pt-6 space-y-4">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <h4 className="font-semibold text-yellow-900 mb-2">💡 Magia das Skills:</h4>
          ...
          <Badge className="mt-2 bg-yellow-600 text-white">Economia de 95% em instruções!</Badge>
        </div>
